...
VALUES
    ...
    ('What is a class in Java?', 'Steve Jobs', ' James Gosling', 'Rasmus Lerdorf', 'Dennis Ritchie', 'An object', 'Easy', 'C'),
    ('Which of the following is not a valid C variable name?', ' int number', 'float rate', 'int variable_count', 'int $main', 'int $main', 'Easy', 'C'),
    ('Which is valid C expression?', 'int my_num = 100,000', 'int my_num = 100000', 'int my num = 1000', 'int $my_num = 10000', 'int $my_num = 10000','Easy', 'C'),
    ('Which of the following cannot be a variable name in C?', 'volatile', 'true', 'friend', 'export', 'volatile' 'Easy', 'C'),
    ('Which of the following typecasting is accepted by C language?', 'Widening conversions','Narrowing conversions' ,'Widening & Narrowing conversions',' None of the mentioned', 'Widening & Narrowing conversions','Easy', 'C');
